...
HD_PWD='E:/project/plus1adder/plus1Adder/plus1Adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log plus1Adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source plus1Adder.tcl -notrace
