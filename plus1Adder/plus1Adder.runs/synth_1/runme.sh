...
HD_PWD='E:/project/plus1adder/plus1Adder/plus1Adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log plus1Adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source plus1Adder.tcl
